...
public class DataLang extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(Main.ID + "."+Constants.GooType+"."+Constants.Goo.Energized +".tip", "§cProvide energy to active it");
        add(Main.ID + "." + Constants.GooType+"."+Constants.Goo.Creative + ".tip", "§cRight click with a wrench to toggle alive state");
