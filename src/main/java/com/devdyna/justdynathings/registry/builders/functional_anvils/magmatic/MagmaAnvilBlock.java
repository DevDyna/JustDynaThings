...
public class MagmaAnvilBlock extends CAnvilBlock {

    public MagmaAnvilBlock() {
    }

    @Nullable
    @Override
    public BlockEntity newBlockEntity(BlockPos p, BlockState s) {
        return new MagmaAnvilBE(zBlockEntities.MAGMATIC_ANVIL.get(), p, s);
    }
    ...
    public boolean isValidBE(BlockEntity b) {
        return b instanceof MagmaAnvilBE;
    }
