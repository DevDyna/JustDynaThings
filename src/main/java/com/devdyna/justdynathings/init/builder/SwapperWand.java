...
public class SwapperWand extends Item {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (item.get(JustDireDataComponents.BOUND_GLOBAL_POS) != null) {
            ...
            player.sendOverlayMessage(Component.translatable(MODULE_ID + ".clear_pos"));
    ...
    public InteractionResult useOn(UseOnContext c) {
        ...
        if (!(!Config.SWAPPER_FAKE_PLAYER_ALLOWED.get() && player instanceof FakePlayer))
    ...
    private void swapFail(Player player) {
        player.sendOverlayMessage(Component.translatable(MODULE_ID + ".init_invalid"));
        failPlace(player);
    }
