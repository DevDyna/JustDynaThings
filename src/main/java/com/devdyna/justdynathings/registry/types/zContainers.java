...
import com.devdyna.justdynathings.registry.builders.functional_anvils.ferricore.FerricoreAnvilGUI;
import com.devdyna.justdynathings.registry.builders.paradox_mixer.ParadoxMixerGUI;
import com.devdyna.justdynathings.registry.builders.reforger.ReforgerGUI;
import com.devdyna.justdynathings.registry.builders.solar.blazegold.BlazegoldSolarPanelGUI;
import com.devdyna.justdynathings.registry.builders.solar.celestigem.CelestigemSolarPanelGUI;
import com.devdyna.justdynathings.registry.builders.solar.eclipsealloy.EclipseAlloySolarPanelGUI;
import com.devdyna.justdynathings.registry.builders.solar.ferricore.FerricoreSolarPanelGUI;
import com.devdyna.justdynathings.registry.builders.thermo.ThermoGUI;
import com.devdyna.justdynathings.registry.builders.ticker.TickerGUI;
...
public class zContainers {
        ...
        public static final DeferredHolder<MenuType<?>, MenuType<ParadoxMixerGUI>> PARADOX_MIXER = zCTNR
                        .register(Constants.Blocks.ParadoxMixer,
                                        () -> IMenuTypeExtension.create(ParadoxMixerGUI::new));
