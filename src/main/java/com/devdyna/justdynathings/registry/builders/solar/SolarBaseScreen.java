...
public abstract class SolarBaseScreen<T extends BaseMachineContainer> extends BaseMachineScreen<T>
        implements ExtraSlots {

    public SolarBaseScreen(T arg0, Inventory arg1, Component arg2) {
