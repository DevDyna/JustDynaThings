...
public class MagmaticAnvilScreen extends BaseMachineScreen<MagmaticAnvilGUI> {
    public MagmaticAnvilScreen(MagmaticAnvilGUI container, Inventory inv, Component name) {
