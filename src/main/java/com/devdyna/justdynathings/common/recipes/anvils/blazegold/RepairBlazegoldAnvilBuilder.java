...
public class RepairBlazegoldAnvilBuilder extends BaseRecipeBuilder
    ...
    private RepairBlazegoldAnvilBuilder(HolderLookup.Provider p) {
        super(p);
        this.criteria = new LinkedHashMap<String, Criterion<?>>();
    }

    public static RepairBlazegoldAnvilBuilder of(HolderLookup.Provider p) {
        return new RepairBlazegoldAnvilBuilder(p);
    }
